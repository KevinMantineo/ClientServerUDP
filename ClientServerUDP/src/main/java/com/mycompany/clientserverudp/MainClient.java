...
import static com.mycompany.clientserverudp.MainServer.ANSI_CYAN;
...
public class MainClient {
    ...
    public static void main(String[] args) {
                ...
                try {    
                    System.out.println(ANSI_YELLOW + "CLIENT UDP" + RESET);
                    //1) RICHIESTA AL SERVER
                    //si recupera l'IP del server UDP
                    serverAddress = InetAddress.getLocalHost(); 
                    System.out.println(ANSI_YELLOW + "Indirizzo del server trovato!" + RESET);
                    ...
                    System.out.println(ANSI_YELLOW + "Richiesta al server inviata!" + RESET);
                    ...
                    System.out.println(ANSI_CYAN + "Lettura dei dati ricevuti dal server" + RESET);
                    
                    messageIn = new String(inPacket.getData(), 0, inPacket.getLength());
                    System.out.println(ANSI_CYAN +"Messaggio ricevuto dal server " + serverAddress +
                        ":" + port + "\n\t" + messageIn + RESET);
